...
![Several displays of different types and sizes next to a Raspberry Pi.](images/display-options.png){:width="450px"}
...
>
> ![HDMI, mini HDMI and micro HDMI plugs side by side.](images/hdmi-sizes.png){:width="450px"}
>
> A Raspberry Pi 4 or 5 has **micro** HDMI. A Raspberry Pi Zero has **mini** HDMI. Monitors use full-size HDMI.
