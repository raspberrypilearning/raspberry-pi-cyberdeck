...
![A microSD card going into the slot on the underside of a Raspberry Pi.](images/inserting-sd-card.png){:width="450px"}
...
**Test:** A light comes on beside the card slot. The raspberry logo appears.
